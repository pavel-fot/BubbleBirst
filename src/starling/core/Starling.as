...
package starling.core
{
     ...
     *  
     *  <pre>var starling:Starling = new Starling(GameField, stage);</pre>
     *  
     *  <p>The first parameter has to be a Starling display object class, e.g. a subclass of 
     *  <code>starling.display.Sprite</code>. In the sample above, the class "GameField" is the
     *  application root. An instance of "GameField" will be created as soon as Starling is initialized.
     ...
     * 
     *  <p>It will now render the contents of the "GameField" class in the frame rate that is set up for
